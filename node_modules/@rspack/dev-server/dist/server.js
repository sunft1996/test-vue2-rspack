    ...
    constructor(options, compiler) {
        super({
            ...
            setupMiddlewares: (middlewares, devServer) => {
                var _a;
                const webpackDevMiddlewareIndex = middlewares.findIndex(mid => mid.name === "webpack-dev-middleware");
                const compilers = compiler instanceof core_1.MultiCompiler ? compiler.compilers : [compiler];
                if (compilers[0].options.builtins.noEmitAssets) {
                    if (Array.isArray(this.options.static)) {
                        const memoryAssetsMiddlewares = this.options.static.flatMap(staticOptions => {
