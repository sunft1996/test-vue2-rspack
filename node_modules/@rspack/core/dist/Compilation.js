            ...
            push: (...errs) => {
                ...
                for (let i = 0; i < errs.length; i++) {
                    ...
                    if ((0, util_1.isJsStatsError)(error)) {
                        __classPrivateFieldGet(this, _Compilation_inner, "f").pushDiagnostic("error", error.title, (0, util_1.concatErrorMsgAndStack)(error));
                    }
        ...
        return {
            ...
            push: (...warns) => {
                ...
                for (let i = 0; i < warns.length; i++) {
                    const warn = warns[i];
                    __classPrivateFieldGet(this, _Compilation_inner, "f").pushDiagnostic("warning", (0, util_1.isJsStatsError)(warn) ? warn.title : warn.name, (0, util_1.concatErrorMsgAndStack)(warn));
                }
            },
            [Symbol.iterator]() {
                // TODO: this is obviously a bad design, optimize this after finishing angular prototype
